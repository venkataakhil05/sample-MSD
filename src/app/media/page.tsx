...
const photos = [
    ...
    { src: 'https://cdn.dnaindia.com/sites/default/files/2018/05/28/687009-csk-ipl-dna-hemant-padalkar.jpg?im=FitAndFill=(1200,900)', title: 'CSK Pride', tag: 'IPL', size: 'large' },
];
